...
public class Lexeme implements Comparable<Lexeme> {
    ...
    public Lexeme(final int offset, final int begin, final int length, final int lexemeType) {
        this.offset = offset;
        this.begin = begin;
        if (length < 0) {
    ...
    @Override
    public int hashCode() {
        final int absBegin = this.getBeginPosition();
        final int absEnd = this.getEndPosition();
     ...
     */
    @Override
    public int compareTo(final Lexeme other) {
        // 起始位置优先
    ...
    public void setLexemeText(final String lexemeText) {
        if (lexemeText == null) {
            this.lexemeText = "";
            this.length = 0;
        } else {
    ...
    public void setLexemeType(final int lexemeType) {
        this.lexemeType = lexemeType;
    }
     ...
     */
    public boolean append(final Lexeme l, final int lexemeType) {
