...
class QuickSortSet {
     ...
     * @param lexeme
     */
    boolean addLexeme(final Lexeme lexeme) {
        final Cell newCell = new Cell(lexeme);
        if (this.size == 0) {
            this.head = newCell;
            this.tail = newCell;
            this.size++;
    ...
    Lexeme pollFirst() {
        if (this.size == 1) {
            final Lexeme first = this.head.lexeme;
            this.head = null;
            this.tail = null;
            this.size--;
            return first;
    ...
    Lexeme pollLast() {
        if (this.size == 1) {
            final Lexeme last = this.head.lexeme;
            this.head = null;
            this.tail = null;
            this.size--;
            return last;
        } else if (this.size > 1) {
            final Lexeme last = this.tail.lexeme;
